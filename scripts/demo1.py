...
runDockerContainer=runDockerContainer + "  - command: 'docker run -dit --privileged=true   --name {0}-0 hadoopimg:v2'\n".format(userName)
...
commands.getoutput("echo y | rm /webcontent/scripts/hdfs-site-master.xml")
commands.getoutput("echo y | rm /webcontent/scripts/runHere3.yml")
commands.getoutput("echo y | rm /webcontent/scripts/runHere2.yml")
commands.getoutput("echo y | rm /webcontent/scripts/runHere1.yml")
...
i=1
while i<= int(totalSlave):
	commands.getoutput("echo y | rm /webcontent/scripts/hdfs-site-master{}.xml".format(i))
	i+=1
